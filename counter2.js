...
ctrHref = trimTrailingSlash('http://www.freevisitorcounters.com'.trim());
ctrHref2 = trimTrailingSlash('http://www.freevisitorcounters.com'.trim());
eInDoc = function(e) {
...
window.onload = function () {
  ...
  linkToHide.innerHTML = '';
    ...
    if (linkfound == false) {
            ...
            div.id = 'error_';
            div.innerHTML = '<a href="http://www.freevisitorcounters.com/en/home/countercode/hashid/?id=bab8ff73e27f6cad1c9eb5e30042b0d49325bb37">Counter Error: Do not change the code. Click here to show the correct code!</a>';
